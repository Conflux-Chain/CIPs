...
* `used_storage_points`: storage points already used for storage collateral. Accessible via `cfx_getSponsorInfo` RPC or `SponsorWhitelistControl` internal contract.
